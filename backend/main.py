...
from simulation import DEFAULT_ZONES, run_simulation_tick, detect_conflicts
...
class SimulateRequest(BaseModel):
    ...
    zones: Optional[list[dict[str, Any]]] = Field(
        None, description="Custom zone layout; defaults to built-in site plan"
    )
...
def simulate(req: SimulateRequest):
    zones = req.zones or DEFAULT_ZONES
